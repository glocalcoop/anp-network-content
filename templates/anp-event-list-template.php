<?php
/*
* Template for the output of the Network Events List
...
$html .= '<li id="event-' . $post_detail['post_id'] . '" data-slug="' . $post_detail['post_slug'] . '" data-id="' . $post_detail['post_id']. '" data-post-date="' . $post_detail['post_date'] . '" data-site="' . $post_detail['site_name'] . '" class="post event">';
